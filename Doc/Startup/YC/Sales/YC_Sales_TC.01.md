...
3.2.1.2.cl=as well as any data that is based on or derived from the Customer Data and provided to Customer as part of the Services
...
5.2.sec={5.2.1.Sen}  {5.2.2.Sen}  {5.2.3.Sen}
