...
Why.2.sec={P2.Le/La} est une société spécialisée dans {Domaine.le/la} (ci-après le « Domaine »). À ce titre, {P2.le/la} est propriétaire d’informations qui sont de nature confidentielle et qui lui appartiennent en propre (ci-après les « {_Éléments_Confidentiels} »).
