...
Intro.7.sec=The “{Def.Post-Money_Valuation_Cap.target}” is {Post-MoneyValueCap.$}.  See Section 2 for certain additional defined terms.
...
Event.LiquidationPriority.1.=[G/Z/ol-a/s3]
...
Def.Liquidity_Price.sec=“{Def.Liquidity_Price.target}” means the price per share equal to the {_Post-Money_Valuation_Cap} divided by the {_Liquidity_Capitalization}.	
