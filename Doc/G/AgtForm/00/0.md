...
PartyList.cl/-2/-and={P1.Name.Full} {and} {P2.Name.Full}
...
PartyList.cl/-2/-or={P1.Name.Full} {or} {P2.Name.Full}
...
Note=The Parties division identifies the parties.  It also can identify some other persons (friends) who are important to the contract and mentioned in it, such as subsidiaries, an agent, a broker or insurer:
...
Note=An example of how sections can be named, and used or not used. Note, the ".LI" normally is completed with a ".Sec" or ".sec", the provides the &lt;li&gt;{*.Sec}&lt;/li&gt;".  It is more direct and more common to build lists using .Sec or .sec, but those lists are fixed.  ".LI"  permits full power to completely remove and rearrange sections.  
...
Note=Xnum(s) are for cross-references to sections, paragraphs, definitions, etc.  This Xnum provides a dummy default. 
