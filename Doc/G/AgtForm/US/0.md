...
Among.Def.sec=Each a "{Def.Party.Target}" and collectively the "{Def.Parties.Target}."

Among.Def.sec/NotTarget=Each a "{Def.Party.Target}" and collectively the "{Def.Parties.Target}."
...
This.sec/2-NotTarget=This {_Agreement} is made as of {EffectiveDate.YMD} (the "{Def.Effective_Date.Target}"), by and between the {_Parties}.
...
This.sec/3-NotTarget=This {_Agreement} is made as of {EffectiveDate.YMD} (the "{Def.Effective_Date.Target}"), by and among the {_Parties}.
