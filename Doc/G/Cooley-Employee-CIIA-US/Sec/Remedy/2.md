...
2.sec=In the event {_Company} enforces this {_Agreement} through a court order, I agree that the restrictions of Section {Solicit.Xnum} will remain in effect for {AntiSolicitEngagements.PeriodFromOrder.cl} from the effective date of the Order enforcing the {_Agreement}.
