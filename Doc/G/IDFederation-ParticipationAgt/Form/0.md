...
This.sec=This Participation Agreement (“Agreement”) for participation in the ID Federation Trust Framework  (the “Trust Framework”) is made and entered into by ID Federation, Inc. of Wilmington, Delaware (“ID Federation”) and _______________________________, a  _________________________  with a principal place of business at _______________ ____________________________ (“Member”). By executing this Agreement, Member accepts and agrees to be legally bound by these terms and conditions for participation in the Trust Framework effective as of the date this Agreement is accepted by the ID Federation (“Effective Date”).

1.Ti=Membership

1.0.sec=Member is signing up for the membership category set forth below and shall pay the applicable membership fee.

1.1.sec=Member Type:  __________________________   

1.2.sec=Fee: _____________________________________
...
4.1.sec=a.	Member must comply with the terms and conditions contained in the By-Laws, Trust Framework, this Agreement and any rules or policies the Board of Directors and Committees may adopt.

4.2.sec=b.	Member must provide the ID Federation with technical, legal, and business contact information as necessary to facilitate the operation of the ID Federation. Member must update this information as necessary.

4.3.sec=c.	Member must bear its own costs and expenses in connection with its participation in the ID Federation, including, but not limited to compensation of Member’s employees and all travel expenses of Member’s employees who attend ID Federation meetings.

4.4.sec=d.	Member agrees not to participate in the ID Federation in a manner that violates federal, state, or local laws or rules or in a manner that interferes or could interfere with services provided by or to others.

4.5.0.sec=e.	In connection with certification by the Assessor, Federation Operator, and/or Policy Authority (each as defined in the Trust Framework), Member shall:

4.5.1.sec=i.	notify impacted personnel of any testing necessary for certification, which shall be conducted under the express authority of Member’s management;
...
5.1.sec=a.	Term.  This Agreement shall begin on the Effective Date and remain in force for the period of one (1) year (unless terminated sooner).  Thereafter, subject to Member’s payment of the then current annual fee and Member otherwise remaining in good standing, the Agreement shall then continue from year to year, unless terminated by Member or the ID Federation in accordance with the terms of this Agreement.

5.2.sec=b.	Termination by Member. The Member may terminate this Agreement at any time and for any reason upon written notice to the ID Federation. Membership Fees of the Member which remain unpaid at the time of termination shall remain due and payable.  In no event shall Member receive any refund of any fees paid.

5.3.sec=c.	Additional Termination Rights.  This Agreement may be terminated as set forth in the Trust Framework.  
...
6.1.sec=a.	It is duly licensed and authorized to conduct its business;

6.2.sec=b.	It is duly authorized to enter into this Agreement.

6.3.sec=c.	It will abide by the Antitrust Compliance requirements contained in the By-Laws and/or Trust Framework.
...
7.2.sec=If to Member: {P2.Notice.Sec}	
...
7.1.sec=If to ID Federation: {P1.Notice.Sec}
