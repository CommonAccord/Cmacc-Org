...
RentalTerm.Alt1.sec={RentalTerm.Month} month to month

RentalTerm.Alt2.sec={RentalTerm.Months} (not to exceed 8 months), unless sooner terminated in accordance with the terms and conditions of this agreement
...
3.0.1.1.sec={Utilities.Separate.List}
...
3.0.2.1.sec={Utilities.Included.List}
