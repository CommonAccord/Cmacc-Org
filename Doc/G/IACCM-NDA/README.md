This repo has model headings for NDAs based on analytical work done by KM Standards for the IACCM.  The model headings include short statements of the content of each section.<br>
