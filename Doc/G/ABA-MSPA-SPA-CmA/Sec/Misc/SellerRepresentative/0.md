...
1.0.sec=Each {_Seller} constitutes and appoints {Seller.Representative.US.N,E,A} as its representative (the "{DefT.Sellers'_Representative}") and its true and lawful attorney in fact, with full power and authority in its name and on its behalf:
