...
Person.cl=reference to any <a href="#SPA.Def.Person.Def" class="definedterm">Person</a> includes such <a href="#SPA.Def.Person.Def" class="definedterm">Person</a>'s successors and assigns, if applicable, but only if such successors and assigns are permitted by {_this_Agreement}, and reference to a <a href="#SPA.Def.Person.Def" class="definedterm">Person</a> in a particular capacity excludes such <a href="#SPA.Def.Person.Def" class="definedterm">Person</a> in any other capacity
