...
Def.xlist=<ul type='none'><li>{Def.Affiliate.sec}</li><li>{Def.Board_of_Directors.sec}</li><li>{Def.Capital_Stock.sec}</li><li>{Def.Change_of_Control.sec}</li><li>{Def.Common_Stock.sec}</li><li>{Def.Company_Notice.sec}</li><li>{Def.DPA.sec}</li><li>{Def.DPA_Triggering_Rights.sec}</li><li>{Def.Foreign_Person.sec}</li><li>{Def.Investor_Notice.sec}</li><li>{Def.Investors.sec}</li><li>{Def.Key_Holders.sec}</li><li>{Def.Preferred_Stock.sec}</li><li>{Def.Proposed_Key_Holder_Transfer.sec}</li><li>{Def.Proposed_Transfer_Notice.sec}</li><li>{Def.Prospective_Transferee.sec}</li><li>{Def.Restated_Certificate.sec}</li><li>{Def.Right_of_Co-Sale.sec}</li><li>{Def.Right_of_First_Refusal.sec}</li><li>{Def.Secondary_Notice.sec}</li><li>{Def.Secondary_Refusal_Right.sec}</li><li>{Def.Transfer_Stock.sec}</li><li>{Def.Undersubscription_Notice.sec}</li></ul>
...
Def.Capital_Stock.sec=“{Def.Capital_Stock.Target}” means (a) shares of Common Stock and Preferred Stock (whether now outstanding or hereafter issued in any context), (b) shares of Common Stock issued or issuable upon conversion of Preferred Stock, and (c) shares of Common Stock issued or issuable upon exercise or conversion, as applicable, of stock options, warrants or other convertible securities of the Company, in each case now owned or subsequently acquired by any Key Holder, any Investor, or their respective successors or permitted transferees or assigns. For purposes of the number of shares of Capital Stock held by an Investor or Key Holder (or any other calculation based thereon), all shares of Preferred Stock shall be deemed to have been converted into Common Stock at the then applicable conversion ratio. 

Def.Change_of_Control.sec=“{Def.Change_of_Control.Target}” means a transaction or series of related transactions in which a person, or a group of related persons, acquires from stockholders of the Company shares representing more than fifty percent (50%) of the outstanding voting power of the Company.

Def.Common_Stock.sec=“{Def.Common_Stock.Target}” means shares of Common Stock of the Company, {Cap.Common.ParValue.$} par value per share.

Def.Company_Notice.sec=“{Def.Company_Notice.Target}” means written notice from the Company notifying the selling Key Holders and each Investor that the Company intends to exercise its Right of First Refusal as to some or all of the Transfer Stock with respect to any Proposed Key Holder Transfer.
