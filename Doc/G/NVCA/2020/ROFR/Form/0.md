...
Why.Alt2.2.sec=WHEREAS, the Company, the Key Holders and certain of the Investors (the “Existing Investors”) previously entered into {PriorROFR.Ti.a}, dated {PriorROFR.EffectiveDate.YMD} (the “{DefT.Prior_Agreement}”), in connection with the purchase of shares of {_Series_Prior_Preferred_Stock} of the Company, par value {Cap.SeriesPriorPreferredStock.ParValue.$} per share (“{DefT.Series_Prior_Preferred_Stock}”);
