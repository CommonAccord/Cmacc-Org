...
This.sec=This {Doc.Ti} (this “{DefT.Agreement.Target}”) is made and entered into as of {EffectiveDate.YMD} (“{DefT.Effective_Date.Target}”), by and between {Company.US.N,E,A} (“{DefT.Company.Target}”) and {Party.US.N,E,A} (“{DefT.Recipient.Target}”) (the {_Company} and {_Recipient}, collectively, the “{DefT.Parties.Target}”).
