...
Company.Pays.sec=Company to pay all legal and administrative costs of the financing{Company.Pays.AtClosing.cl}, including (subject to the Closing) reasonable fees (not to exceed {Investor.1.Counsel.Fee.Max.$}) and expenses of Investor counsel.
...
IRA.PreferredDirectorApprovalRequired.5.sec=incur any aggregate indebtedness in excess of {PreferredDirectorApprovalRequired.ForDebt.TotalMoreThan.$} that is not already included in a Board-approved budget, other than trade credit incurred in the ordinary course of business; 
...
IRA.PreferredDirectorApprovalRequired.9.sec=enter into any corporate strategic relationship involving the payment contribution or assignment by the Company or to the Company of {PreferredDirectorApprovalRequired.ForCorporateRelationship.AssetTotalMoreThan.$}.
