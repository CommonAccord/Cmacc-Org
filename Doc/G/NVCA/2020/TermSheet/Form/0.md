...
Offer.Investor.Other.sec=as well other investors mutually agreed upon by Investors and the Company

Offer.Investor.WithOther.sec=<ol><li>{Offer.Investor.1.sec}</li><li>{Offer.Investor.2.sec}</li><li>{Offer.Investor.Other.sec}</li></ol>

Offer.Investor.WithOutOther.sec=<ol><li>{Offer.Investor.1.sec}</li><li>{Offer.Investor.2.sec}</li></ol>

Offer.Investor.sec=<span class="select">Select one: {SecName}Offer.Investor.sec=</span><ol><li><span class="select">{SecName}Offer.Investor.WithOther.sec: </span>{Offer.Investor.WithOther.sec}</li><li><span class="select">{SecName}Offer.Investor.WithOutOther.sec: </span>{Offer.Investor.WithOutOther.sec}</li></ol>
...
Charter.SeriesAApprovalRequired.PayJuniorDividend.IncludingPreferredDirector.sec=, including the approval of [at least one] Preferred Director
...
Charter.SeriesAApprovalRequired.NewDebt.UnlessApprovedByBoard.IncludingPreferredDirector.sec=, including the approval of [at least one] Preferred Director
