...
Offer.ClosingDate.SingleClosing.sec=As soon as practicable following the Company’s acceptance of this Term Sheet and satisfaction of the conditions to closing (the “{Def.Closing.Target}”).
...
IRA.Registration.RegistrableSecurities.sec=All shares of Common Stock issuable upon conversion of the {_Series_A_Preferred} and any other Common Stock held by the Investors will be deemed “{Def.Registrable_Securities.Target}.”

IRA.Registration.RegistrableSecurities.=[G/Z/Base]

IRA.Registration.OnDemand.Ti=Demand Registration:

IRA.Registration.OnDemand.1.0.sec=Upon earliest of

IRA.Registration.OnDemand.1.1.sec={Registration.OnDemand.PeriodAfterTheClosing.Duration.3-5years} after the Closing; or

IRA.Registration.OnDemand.1.2.sec={Registration.OnDemand.PeriodAfterIPO.Duration.six-months} following an initial public offering (“{Def.IPO.Target}”), 

IRA.Registration.OnDemand.1.00.sec=persons holding {Registration.OnDemand.AtLeastShareholdersOf.%} of the Registrable Securities may request [one][two] (consummated) registrations by the Company of their shares.


IRA.Registration.OnDemand.1.=[G/Z/ol-i/s2]

IRA.Registration.OnDemand.2.sec=The aggregate offering price for such registration may not be less than {Registration.OnDemand.Offering.AggregatePrice.AtLeast.$}.

IRA.Registration.OnDemand.3.0.sec=A registration will count for this purpose only if

IRA.Registration.OnDemand.3.1.sec=all Registrable Securities requested to be registered are registered, and 

IRA.Registration.OnDemand.3.2.sec=it is closed, or withdrawn at the request of the Investors (other than as a result of a material adverse change to the Company).  

IRA.Registration.OnDemand.3.=[G/Z/ol-i/s2]
...
IRA.Registration.Lock-Up.Base.sec=Investors shall agree in connection with the IPO, if requested by the managing underwriter, not to sell or transfer any shares of Common Stock of the Company held immediately before the effective date of the IPO for a period of up to 180 days following the IPO (provided all directors and officers of the Company [and [1 – 5]% stockholders] agree to the same lock-up).
...
IRA.Manage-Info.2.1.sec=Any {Investor/Major_Investor} (who is not a competitor) will be granted access to Company facilities and personnel during normal business hours and with reasonable advance notification.

IRA.Manage-Info.2.2.0.sec=The Company will deliver to such {Investor/Major_Investor}
