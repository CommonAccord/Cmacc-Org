...
IRA.Registration.2.1.1.sec=[three (3)-five (5)] years after the Closing; or

IRA.Registration.2.1.2.sec=[six (6)] months following an initial public offering (“{Def.IPO.Target}”), 
...
IRA.Registration.2.2.sec=The aggregate offering price for such registration may not be less than {Registration.Demand.Offering.AggregatePrice.AtLeast.$}.
...
IRA.Registration.3.sec=The holders of [10-30]% of the] Registrable Securities will have the right to require the Company to register on Form S-3, if available for use by the Company, Registrable Securities for an aggregate offering price of at least $[3-5 million].  There will be no limit on the aggregate number of such Form S-3 registrations, provided that there are no more than [two (2)] per twelve (12) month period.
