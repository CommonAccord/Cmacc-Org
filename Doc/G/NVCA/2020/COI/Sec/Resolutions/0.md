...
4.0.1.1.sec={Cap.Common.Authorized.Number} shares of Common Stock, {Cap.Common.ParValue.$} par value per share (“{Def.Common_Stock.Target}”) and

4.0.1.2.sec={Cap.Preferred.Authorized.Number} shares of Preferred Stock, {Cap.SeriesA.ParValue.$} par value per share (“{Def.Preferred_Stock.Target}”). 
