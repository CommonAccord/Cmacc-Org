...
1.sec=The name of this corporation is {Company.Name.Full} (the “{DefT.Corporation.Target}”).
...
4.0.1.1.sec={Cap.Common.Authorized.Number} shares of Common Stock, {Cap.Common.ParValue.$} par value per share (“{DefT.Common_Stock.Target}”) and

4.0.1.2.sec={Cap.Preferred.Authorized.Number} shares of Preferred Stock, {Cap.SeriesA.ParValue.$} par value per share (“{DefT.Preferred_Stock.Target}”). 
