...
Def.Company_Intellectual_Property.1.sec=patents, patent applications, registered and unregistered trademarks, trademark applications, registered and unregistered service marks, service mark applications, tradenames, copyrights, trade secrets, domain names, {Def.Company_Intellectual_Property.Includes.mask_works.Yes/No} information and proprietary rights and processes, similar or other intellectual property rights,

Def.Company_Intellectual_Property.Includes.mask_works.Yes=mask works,

Def.Company_Intellectual_Property.Includes.mask_works.No=</>
...
Def.Management_Rights_Letter.sec=“{Def.Management_Rights_Letter.Target}” means the agreement between the Company and {MRL.Investors.Names.cl}, dated as of the date of the Initial Closing, in the form of Exhibit {Annex.ManagementRights.Xnum} attached to this Agreement.
...
CompanyRep.Litigation.1.2.sec={CompanyRep.Litigation.Claim.ValidityOfTransaction.CompanyKnows.Yes/No} the validity of the Transaction Agreements or the right of the Company to enter into them, or to consummate the transactions contemplated by the Transaction Agreements; or

CompanyRep.Litigation.Claim.ValidityOfTransaction.CompanyKnows.Yes=to the Company's knowledge, that questions

CompanyRep.Litigation.Claim.ValidityOfTransaction.CompanyKnows.No=that questions
...
CompanyRep.IP.2.sec={CompanyRep.IP.Infringe.CompanyKnows.Yes/No} product or service marketed or sold (or proposed to be marketed or sold) by the Company violates or will violate any license or infringes or will infringe any intellectual property rights of any other party.

CompanyRep.IP.Infringe.CompanyKnows.Yes=To the Company's knowledge, no

CompanyRep.IP.Infringe.CompanyKnows.No=No
...
CompanyRep.IP.5.2.sec={CompanyRep.IP.Employee.PriorInventions.CompanyKnows.Yes/No} be necessary to use any inventions of any of its employees or consultants (or Persons it currently intends to hire) made prior to their employment by the Company, including prior employees or consultants{CompanyRep.IP.PriorInventions.Institution./or_academic}.

CompanyRep.IP.Employee.PriorInventions.CompanyKnows.Yes=To the Company's knowledge, it will not

CompanyRep.IP.Employee.PriorInventions.CompanyKnows.No=It will not
