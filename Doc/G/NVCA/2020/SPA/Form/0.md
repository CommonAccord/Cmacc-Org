...
CompanyRep.Litigation.1.2.sec={CompanyRep.CompanyKnows.yes/no} that questions the validity of the Transaction Agreements or the right of the Company to enter into them, or to consummate the transactions contemplated by the Transaction Agreements; or

CompanyRep.CompanyKnows.yes=to the Company's knowledge,

CompanyRep.CompanyKnows.no=</>
...
CompanyRep.Transactions.2.2.0.sec=None of the Company’s directors, officers or employees, or any members of their immediate families, or any Affiliate of the foregoing are, directly or indirectly, indebted to the Company or{CompanyRep.CompanyKnows.yes/no} have any
...
CompanyRep.FinancialStatement.1.1.sec=The Company has delivered to each Purchaser its {CompanyRep.unaudited/audited} financial statements as of {CompanyRep.FinancialStatement.MostRecent.YMD} and for the fiscal year ended {CompanyRep.FinancialStatement.FiscalYearEnd.YMD}
...
CompanyRep.FinancialStatement.1.3.sec=(the “Balance Sheet Date”) and for the {CompanyRep.FinancialStatement.UnauditedP&L.ForMostRecent.month-period} ended on the Balance Sheet Date (collectively, the “{Def.Financial_Statements.Target}”).

CompanyRep.FinancialStatement.1.=[G/Z/para/s3]

CompanyRep.FinancialStatement.2.sec=The Financial Statements have been prepared in accordance with generally accepted accounting principles (“{Def.GAAP.Target}”) applied on a consistent basis throughout the periods indicated{CompanyRep.FinancialStatement.NoGAAPFootnotesForUnaudited.yes/no}.
...
CompanyRep.Employee.1.sec={CompanyRep.EmployeeMatters.CompanyKnows.Yes/No} is obligated under any contract (including licenses, covenants or commitments of any nature) or other agreement, or subject to any judgment, decree or order of any court or administrative agency, that would materially interfere with such employee’s ability to promote the interest of the Company or that would conflict with the Company’s business. Neither the execution or delivery of the Transaction Agreements, nor the carrying on of the Company’s business by the employees of the Company, nor the conduct of the Company’s business as now conducted and as presently proposed to be conducted, will, {CompanyRep.CompanyKnows.yes/no} conflict with or result in a breach of the terms, conditions, or provisions of, or constitute a default under, any contract, covenant or instrument under which any such employee is now obligated.

CompanyRep.EmployeeMatters.CompanyKnows.Yes=To the Company’s knowledge, none of its employees

CompanyRep.EmployeeMatters.CompanyKnows.No=None of its employees
...
CompanyRep.Environment.1.1.0.sec=Except as could not reasonably be expected to have a Material Adverse Effect{-9_to_the_best_of_the_Company7s_knowledge-}

CompanyRep.Environment.1.1.1.sec=the Company is and has been in compliance with all Environmental Laws;

CompanyRep.Environment.1.1.2.sec=there has been no release or{-9_to_the_Company7s_knowledge9-} threatened release of any pollutant, contaminant or toxic or hazardous material, substance or waste or petroleum or any fraction thereof (each a “{Def.Hazardous_Substance.Target}”), on, upon, into or from any site currently or heretofore owned, leased or otherwise used by the Company;
...
CompanyRep.DataPrivacy.4.sec=The Company is and has been{-9_to_the_Company7s_knowledge9-} in compliance in all material respects with all laws relating to data loss, theft and breach of security notification obligations.
...
CompanyRep.ExportControl.3.sec=there are no pending or{-9_to_the_Company7s_knowledge9-} threatened claims against the Company with respect to such exports, classifications, required filings or other approvals;
...
CompanyRep.Disclosure.2.sec=No representation or warranty of the Company contained in this Agreement, as qualified by the Disclosure Schedule, and no certificate furnished or to be furnished to Purchasers at the Closing contains any untrue statement of a material fact or{-9_to_the_Company7s_knowledge9-} omits to state a material fact necessary in order to make the statements contained herein or therein not misleading in light of the circumstances under which they were made.
...
Misc.Notice.1.3.sec=If notice is given to the Company, a copy (which copy shall not constitute notice) shall also be sent to {Company.Counsel.N,E,A} and if notice is given to the Purchasers, a copy (which copy shall not constitute notice) shall also be given to {Counsel.N,E,A}.
...
Misc.Expenses.sec=At the Closing, the Company shall pay the reasonable fees and expenses of {Investor.1.Counsel.Name.Full}, the counsel for {Investor.1.Name.Full}, in an amount not to exceed, in the aggregate, {Investor.1.Counsel.Fee.Max.$}.
...
Misc.AmendAndWaive.1.1.sec=the holders of at least {SPA.AmendAgreement.Approval.ShareHolder.%} of the then-outstanding Shares

Misc.AmendAndWaive.1.2.sec=for an amendment, termination or waiver effected prior to the Initial Closing, Purchasers obligated to purchase {SPA.AmendAgreement.Approval.ShareHolder.%} of the Shares to be issued at the Initial Closing
...
00.sec={Witness.sec}<br>{Company.US.Contract.By.Sec}<br><br>{Witness.sec}<br>{US.Contract.By.Sec}
