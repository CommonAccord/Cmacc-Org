...
PurchaserRep.CFIUS.1.sec=The Purchaser is not a “foreign person” or a “foreign entity,” as defined in Section 721 of the Defense Production Act of 1950, as amended, including all implementing regulations thereof (the “{Def.DPA.Target}”).
...
Misc.Expenses.sec=At the Closing, the Company shall pay the reasonable fees and expenses of {Purchasers.Counsel.Name.Full}, the counsel for {Investor.1.Name.Full}, in an amount not to exceed, in the aggregate, {Purchasers.Counsel.Fee.Max.$}.
