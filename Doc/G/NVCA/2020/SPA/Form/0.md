...
This.sec=THIS SERIES A PREFERRED STOCK PURCHASE AGREEMENT (this “{Def.Agreement.Target}”), is made as of {SPA.EffectiveDate.YMD}, by and among {Company.N,E,A} (the “{Def.Company.Target}”) and the investors listed on Exhibit {Annex.Purchasers.Xnum} attached to this Agreement (each a “{Def.Purchaser.Target}” and together the “Purchasers”).
