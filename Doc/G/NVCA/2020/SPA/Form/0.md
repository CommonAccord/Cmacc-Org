...
ProofersNote=Section 1.3 has one (1) section, labeled (a).  That is inconsistent with other sections and unneeded.  It should be Section 1.3, not Section 1.3(a). Have made the change. In the {Misc.Dispute.Sec}, have renumbered some of the subsections in the process of aerating them.  
...
Misc.xlist=<ol><li>{Misc.SurvivalOfWarranties.Sec}</li><li>{Misc.Assign.Sec}</li><li>{Misc.GoverningLaw.Sec}</li><li>{Misc.Counterpart.Sec}</li><li>{Misc.Titles.Sec}</li><li>{Misc.Notice.Sec}</li><li>{Misc.FindersFee.Sec}</li><li>{Misc.Expenses.Sec}</li><li>{Misc.AttyFee.Sec}</li><li>{Misc.AmendAndWaive.Sec}</li><li>{Misc.Sever.Sec}</li><li>{Misc.Waive.Sec}</li><li>{Misc.EntireAgt.Sec}</li><li>{Misc.SecuritiesLaw.Sec}</li><li>{Misc.CancelClosing.Sec}</li><li>{Misc.Dispute.Sec}</li><li>{Misc.NoCommitmentToFurtherFund.Sec}</li><li>{Misc.WaiveCounselConflict.Sec}</li></ol>
...
Misc.Dispute.Xnum=<a class='xref' href='{!!!}Misc.Dispute.sec'>6.16</a>
