...
This.sec=THIS SERIES A PREFERRED STOCK PURCHASE AGREEMENT (this “{Def.Agreement.Target}”), is made as of {EffectiveDate.YMD}, by and among {Company.N,E,A} (the “{Def.Company.Target}”) and the investors listed on Exhibit {Annex.Purchasers.Xnum} attached to this Agreement (each a “{Def.Purchaser.Target}” and together the “Purchasers”).
...
Purchase.Closing(b).Xnum=<a href='#SPA.Purchase.Closing.2.sec'>1.2(b)</a>

Purchase.AdditionalShares(a).Xnum=<a href='#SPA.Purchase.AdditionalShares.1.sec'>1.3(a)</a>

CompanyRep.Agreements.Xnum=<a href='#SPA.CompanyRep.Agreements.Sec'>2.10</a>

CompanyRep.Changes.Xnum=<a href='#SPA.CompanyRep.Changes.Sec'>2.15</a>

CompanyRep.Employee-Agreements.Xnum=<a href='#SPA.CompanyRep.Employee-Agreements.Sec'>2.19</a>

CompanyRep.Capital.Xnum=<a href='#SPA.CompanyRep.Capital.Sec'>2.2</a>

CompanyRep.Capital(a)(ii).Xnum=<a href='#SPA.CompanyRep.Capital.1.2.sec'>2.2(a)(ii)</a>

CompanyRep.Capital(b).Xnum=<a href='#SPA.CompanyRep.Capital.2.sec'>2.2(b)</a>

CompanyRep.Environment.Xnum=<a href='#SPA.CompanyRep.Environment.Sec'>2.24</a>

CompanyRep.Subsidiary.Xnum=<a href='#SPA.CompanyRep.Subsidiary.Sec'>2.3</a>

CompanyRep.Authorize.Xnum=<a href='#SPA.CompanyRep.Authorize.Sec'>2.4</a>

CompanyRep.Issuance.Xnum=<a href='#SPA.CompanyRep.Issuance.Sec'>2.5</a>

CompanyRep.Government-Consent.Xnum=<a href='#SPA.CompanyRep.Government-Consent.Sec'>2.6</a>

CompanyRep.IP.Xnum=<a href='#SPA.CompanyRep.IP.Sec'>2.8</a>

CompanyRep.Xnum=<a href='#SPA.CompanyRep.Sec'>2</a>

PurchaserRep.Xnum=<a href='#SPA.PurchaserRep.Sec'>3</a>

PurchaserCond.CompanyReps.Xnum=<a href='#SPA.PurchaserCond.CompanyReps.Sec'>4.1</a>

PurchaserCond.CompanyComply.Xnum=<a href='#SPA.PurchaserCond.CompanyComply.Sec'>4.2</a>

PurchaserCond.Xnum=<a href='#SPA.PurchaserCond.Sec'>4</a>

Misc.AmendAndWaive.Xnum=<a href='#SPA.Misc.AmendAndWaive.Sec'>6.10</a>

Misc.DisputeResolution.Xnum=<a href='#SPA.Misc.DisputeResolution.sec'>6.16</a>

Misc.Notice.Xnum=<a href='#SPA.Misc.Notice.Sec'>6.6</a>

Annex.DisclosureSchedule.2.16(c)(i).Xnum=<a href='#SPA.Annex.3.Sec'>2.16(c)(i)</a>

Annex.DisclosureSchedule.2.16(c)(ii).Xnum=<a href='#SPA.Annex.3.Sec'>2.16(c)(ii)</a>

Annex.DisclosureSchedule.2.16(f).Xnum=<a href='#SPA.Annex.3.Sec'>2.16(f)</a>

Annex.DisclosureSchedule.2.2(c).Xnum=<a href='#SPA.Annex.3.Sec'>2.2(c)</a>

Annex.DisclosureSchedule.2.8(f).Xnum=<a href='#SPA.Annex.3.sec'>2.8(f)</a>

Annex.Purchasers.Xnum=<a href='#SPA.Annex.1.Sec'>A</a>

Annex.CertOfIncorp.Xnum=<a href='#SPA.Annex.2.Sec'>B</a>

Annex.DisclosureSchedule.Xnum=<a href='#SPA.Annex.3.Sec'>C</a>

Annex.Indemnify.Xnum=<a href='#SPA.Annex.4.Sec'>D</a>

Annex.InvestorsRights.Xnum=<a href='#SPA.Annex.5.Sec'>E</a>

Annex.ManagementRights.Xnum=<a href='#SPA.Annex.6.Sec'>F</a>

Annex.FirstRefusal.Xnum=<a href='#SPA.Annex.7.Sec'>G</a>

Annex.VotingAgt.Xnum=<a href='#SPA.Annex.8.Sec'>H</a>

Annex.LegalOpinion.Xnum=<a href='#SPA.Annex.9.Sec'>I</a>
...
_Code=<a href='#SPA.Def.Code.Target' class='definedterm'>Code</a>

_Company_Intellectual_Property=<a href='#SPA.Def.Company_Intellectual_Property.Target' class='definedterm'>Company Intellectual Property</a>

_Indemnification_Agreement=<a href='#SPA.Def.Indemnification_Agreement.Target' class='definedterm'>Indemnification Agreement</a>

_Investors’_Rights_Agreement=<a href='#SPA.Def.Investors’_Rights_Agreement.Target' class='definedterm'>Investors’ Rights Agreement</a>

_Key_Employee=<a href='#SPA.Def.Key_Employee.Target' class='definedterm'>Key Employee</a>

_Knowledge=<a href='#SPA.Def.Knowledge.Target' class='definedterm'>Knowledge</a>

_Management_Rights_Letter=<a href='#SPA.Def.Management_Rights_Letter.Target' class='definedterm'>Management Rights Letter</a>

_Material_Adverse_Effect=<a href='#SPA.Def.Material_Adverse_Effect.Target' class='definedterm'>Material Adverse Effect</a>

_Right_of_First_Refusal_and_Co-Sale_Agreement=<a href='#SPA.Def.Right_of_First_Refusal_and_Co-Sale_Agreement.Target' class='definedterm'>Right of First Refusal and Co-Sale Agreement</a>

_Securities_Act=<a href='#SPA.Def.Securities_Act.Target' class='definedterm'>Securities Act</a>

_Transaction_Agreements=<a href='#SPA.Def.Transaction_Agreements.Target' class='definedterm'>Transaction Agreements</a>

_Voting_Agreement=<a href='#SPA.Def.Voting_Agreement.Target' class='definedterm'>Voting Agreement</a>


CodersNote=Dummy variables to speed rendering:


/Doc.GUID=<span class='missing'>Doc.GUID</span>

/P1.Name.Full=<span class='missing'>P1.Name.Full</span>

/P2.Name.Full=<span class='missing'>P2.Name.Full</span>

/EffectiveDate.YMD=<span class='missing'>EffectiveDate.YMD</span>

/P1.US.Contract.Among.Sec=<span class='missing'>P1.US.Contract.Among.Sec</span>

/P2.US.Contract.Among.Sec=<span class='missing'>P2.US.Contract.Among.Sec</span>

/EffectiveDate.YMD=<span class='missing'>EffectiveDate.YMD</span>

/Company.N,E,A=<span class='missing'>Company.N,E,A</span>

-applicable-=<span class='missing'>-applicable-</span>

Cap.SeriesA.ParValue.$=<span class='missing'>Cap.SeriesA.ParValue.$</span>

Cap.SeriesA.PricePerShare.$=<span class='missing'>Cap.SeriesA.PricePerShare.$</span>

Closing.Time.YMDHM= <span class='missing'>___ a.m.</span> on {ClosingDate.YMD} 

PayBySecurities.Interest.Yes/No=<span class='missing'>PayBySecurities.Interest.Yes/No</span>

Cap.SeriesA.AdditionalShares.Quantity.#=<span class='missing'>Cap.SeriesA.AdditionalShares.Quantity.#</span>

AdditionalPurchasersMustBeApproved.Yes/No=<span class='missing'>AdditionalPurchasersMustBeApproved.Yes/No</span>

/Company.Counsel.Name.Full=<span class='missing'>Company.Counsel.Name.Full</span>

mask_works.Yes/No=<span class='missing'>mask_works.Yes/No</span>

CompanyIP.InConduct.Used/Necessary=<span class='missing'>CompanyIP.InConduct.Used/Necessary</span>
...
Purchaser.Name.Full=<span class='missing'>Purchaser.Name.Full</span>
