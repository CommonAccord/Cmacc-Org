...
This.sec=THIS {Doc.Ti} (the “{Def.Agreement.Target}”) is made and entered into as of {EffectiveDate.YMD} between {Company.Name.Full}, a Delaware corporation (the “{Def.Company.Target}”), and {Party.Name.Full} (“{Def.Indemnitee.Target}”).
