...
This.sec=<span style="text-transform: uppercase">This {Doc.Ti}</span> (this “{Def.Agreement.Target}”), is made as of {EffectiveDate.YMD}, by and among {Company.N,E,A} (the “{Def.Company.Target}”), {This.OtherParties.sec}
