...
Misc.xlist=<ol><li>{Misc.Assign.Sec}</li><li>{Misc.GoverningLaw.Sec}</li><li>{Misc.Counterpart.Sec}</li><li>{Misc.Titles.Sec}</li><li>{Misc.Notice.Sec}</li><li>{Misc.Amend-Waive.Sec}</li><li>{Misc.Sever.Sec}</li><li>{Misc.AggregationOfStock.Sec}</li><li>{Misc.AdditionalInvestors.Sec}</li><li>{Misc.EntireAgreement.Sec}</li><li>{Misc.Dispute.Sec}</li><li>{Misc.Delay-Omission.Sec}</li></ol>
...
Misc.Dispute.=[G/NVCA/2020/Share/Sec/Dispute/0.md]

Misc.Dispute.SecName={SecName}Misc.Dispute
...
DefT.=[G/NVCA/2020/Share/Z/Def/Link.md]
...
Note=Investor Name, Address, Phone Number, Email, [Counsel cc, if any]
...
Note=IN WITNESS WHEREOF, the Company has provided this Checklist on [Date checklist is being delivered].
[Company Name], By:, Name:, Title: 	
...
Misc.Dispute.Xnum={Misc.Xnum}.<a class='xref' href='{!!!}Misc.Dispute.Sec'>11</a>
