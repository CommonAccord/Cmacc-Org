...
Semantic.sec={If}{Request}{ByHolders}{ToFile}{ThenFile}{Limit}{NotForeigner}
...
4.0.sec=that the Company file a Form S-1 registration statement with respect to {4.xlist}

5.0.sec=then the Company shall: {5.xlist}
