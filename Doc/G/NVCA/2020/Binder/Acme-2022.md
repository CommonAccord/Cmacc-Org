...
/Investor.1.=[G/NVCA/2020/Binder/Acme-Investor-StateStreet.md]

/Investor.2.=[G/NVCA/2020/Binder/Acme-Investor-Quake.md]
...
ScheduleOfInvestors.sec=<ol><li>{Investor.1.Shares.#} Shares - Investor 1: {Investor.1.US.N,E,A}</li><li>{Investor.2.Shares.#} Shares - Investor 2: {Investor.2.US.N,E,A}</li><li>{Investor.3.Shares.#} Shares - Investor 3: {Investor.3.US.N,E,A}</li></ol>

ScheduleOfKeyHolders.sec=<ol><li>{Investor.1.Shares.#} Shares - Investor 1: {Investor.1.US.N,E,A}</li><li>{Investor.2.Shares.#} Shares - Investor 2: {Investor.2.US.N,E,A}</li></ol>
...
Board.Director.VotedBySeriesB.Number(#)=one (1)

Board.Director.VotedByCommon.Number(#).directors=two (2) directors

Board.Director.VotedBySeriesA.Number(#).directors=one (1) director

Board.Director.VotedBySeriesB.Number(#).directors=one (1) director
...
CompanyKnows.ListOfOfficers={Company.President.Name.Full} and {Board.Director.1.Name.Full}
...
IRA.PreferredDirector.ElectedBy.Class.Yes/No={IRA.PreferredDirector.ElectedBy.Class.Yes}

IRA.PreferredDirector.ElectedBy.SeriesA.Yes/No={IRA.PreferredDirector.ElectedBy.SeriesA.Yes}
...
ROFR.Misc.DisputeResolution.sec={ROFR.Misc.DisputeResolution.Court.sec}
...
COI.Link=<a href='{SourceRoot!!}COI.Model.Root'>Certificate of Incorporation Link</a>

SourceRoot!!=i.php?v=doc&f=G/NVCA/2020/Binder/Acme-2022-Investor-StateStreet.md&k=

Indemn.#!!=#Indemn.

Indemn.SecName=Indemn.

Indemn.Link=<a href='{SourceRoot!!}Indemn.Model.Root'>Indemnity Agreement Link</a>

IRA.#!!=#IRA.

IRA.SecName=IRA.

IRA.Link=<a href='{SourceRoot!!}IRA.Model.Root'>Investor's Rights Agreement Link</a>

MRL.#!!=#MRL.

MRL.SecName=MRL.

MRL.Link=<a href='{SourceRoot!!}MRL.Model.Root'>Management Rights Letter Link</a>

CDA.#!!=#CDA.

CDA.SecName=CDA.

CDA.Link=<a href='{SourceRoot!!}CDA.Model.Root'>Confidential Disclosure Agreement Link</a>

ROFR.#!!=#ROFR.

ROFR.SecName=ROFR.

ROFR.Link=<a href='{SourceRoot!!}ROFR.Model.Root'>Right of First Refusal Link</a>

SPA.#!!=#SPA.

SPA.SecName=SPA.

SPA.Link=<a href='{SourceRoot!!}SPA.Model.Root'>Share Purchase Agreement Link</a>

TermSheet.#!!=#TermSheet.

TermSheet.SecName=TermSheet.

TermSheet.Link=<a href='{SourceRoot!!}TermSheet.Model.Root'>Term Sheet Link</a>

Voting.#!!=#Voting.

Voting.SecName=Voting.

Voting.Link=<a href='{SourceRoot!!}Voting.Model.Root'>Voting Agreement Link</a>
