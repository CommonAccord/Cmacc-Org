...
LicenseTermSheet.=[G/NVCA/2020/LS-License-TermSheet/Form/0.md]
...
Investor.3.=[G/NVCA/2020/Binder/Acme-Investor-NIH.md]
...
TechTransferor.=[G/U/Who/mit_edu.md]
...
ScheduleOfKeyHolders.sec=<ol><li>{Investor.1.Shares.#} Shares - Investor 1: {Investor.1.Party.US.N,E,A}</li><li>{Investor.2.Shares.#} Shares - Investor 2: {Investor.2.Party.US.N,E,A}</li></ol>
