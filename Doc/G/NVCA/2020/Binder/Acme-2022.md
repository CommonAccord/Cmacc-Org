...
COI.Link=<a href='{!!!}COI.Model.Root'>Certificate of Incorporation Link</a>
...
Indemn.Link=<a href='{!!!}Indemn.Model.Root'>Indemnity Agreement Link</a>

IRA.!!!={!!!}IRA.

IRA.SecName=IRA.

IRA.Link=<a href='{!!!}IRA.Model.Root'>Investor's Rights Agreement Link</a>

MRL.!!!={!!!}MRL.

MRL.SecName=MRL.

MRL.Link=<a href='{!!!}MRL.Model.Root'>Management Rights Letter Link</a>

CDA.!!!={!!!}CDA.

CDA.SecName=CDA.

CDA.Link=<a href='{!!!}CDA.Model.Root'>Confidential Disclosure Agreement Link</a>

ROFR.!!!={!!!}ROFR.

ROFR.SecName=ROFR.

ROFR.Link=<a href='{!!!}ROFR.Model.Root'>Right of First Refusal Link</a>

SPA.!!!={!!!}SPA.

SPA.SecName=SPA.

SPA.Link=<a href='{!!!}SPA.Model.Root'>Share Purchase Agreement Link</a>

TermSheet.!!!={!!!}TermSheet.

TermSheet.SecName={SecName}TermSheet.

TermSheet.Link=<a href='{!!!}TermSheet.Model.Root'>Term Sheet Link</a>

Voting.!!!={!!!}Voting.

Voting.SecName=Voting.

Voting.Link=<a href='{!!!}Voting.Model.Root'>Voting Agreement Link</a>
