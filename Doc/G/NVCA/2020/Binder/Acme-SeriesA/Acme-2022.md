...
Director.VotedByCommon.Number(#).directors=two (2) directors

Director.VotedBySeriesA.Number(#).directors=one (1) director

Director.VotedBySeriesB.Number(#).directors=one (1) director
