...
Why.2.1.sec=(a) the holders of record of the shares of the [Series A] Preferred Stock, exclusively and as a separate class, shall be entitled to elect {Board.Director.VotedBySeriesA.Number(#)} director[s] of the Company (the “{Def.Series_A_Preferred_Director.Target}//{Def.Preferred_Director.Target}[s]”) [and the holders of record of the shares of Series B Preferred Stock, exclusively and as a separate class, shall be entitled to elect {Board.Director.VotedBySeriesB.Number(#)} director[s] of the Company (the “{Def.Series_B_Preferred_Director.Target}//{Def.Preferred_Director.Target}[s]”)]; 
...
Sign.Sec={Company.US.Contract.By.Sec}<br>{KeyHolder.US.Contract.By.Sec}<br>{Investor.US.Contract.By.Sec}
