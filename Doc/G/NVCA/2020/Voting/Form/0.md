...
This.OnSchedule.cl=listed on Schedule A (together with any subsequent investors, or transferees, who become parties hereto as “{DefT.Investors}” pursuant to Sections {Misc.AdditionalParties.1.Xnum} or {Misc.ShareTransfer.Xnum} below, the “{DefT.Investors}”), and those certain stockholders of the Company [and holders of options to acquire shares of the capital stock of the Company] listed on Schedule B (together with any subsequent stockholders [or option holders], or any transferees, who become parties hereto as “{DefT.Key_Holders}” pursuant to Section[s {Misc.AdditionalParties.2.Xnum} or] {Misc.ShareTransfer.Xnum} below, the “{DefT.Key_Holders},”  and together collectively with the Investors, the “{DefT.Stockholders}”).
...
Board.Who.00.1.sec=To the extent that any of clauses (a) through [(e)] above shall not be applicable, any member of the Board who would otherwise have been designated in accordance with the terms thereof shall instead be voted upon by all the Stockholders of the Company entitled to vote thereon in accordance with, and pursuant to, the Restated Certificate.
...
DragAlong.Engage.0.3.sec=subject to satisfaction of each of the conditions set forth in Section {DragAlong.Xnum}.3 below, 
...
Misc.ConsentToAmend.4.KeyHolders.All/ProvidingServices/HoldingShares=<span class='select'>{SecName}Misc.ConsentToAmend.4.KeyHolders.All/ProvidingServices/HoldingShares</span>

Misc.ConsentToAmend.4.KeyHolders.All=the Key Holders

Misc.ConsentToAmend.4.KeyHolders.ProvidingServices=the Key Holders who are at such time providing services to the Company as an officer, employee or consultant

Misc.ConsentToAmend.4.KeyHolders.HoldingShares=the holders of [specify percentage] of shares of Common Stock
...
Board.Who.Xnum={Board.Xnum}.<a class='xref' href='{!!!}Board.Who.Sec'>2</a>

Board.Who.1.Xnum={Board.Xnum}.<a class='xref' href='{!!!}Board.Who.1.sec'>2(a)</a>

Board.Who.2.Xnum={Board.Xnum}.<a class='xref' href='{!!!}Board.Who.2.sec'>2(b)</a>

Board.Who.3.Xnum={Board.Xnum}.<a class='xref' href='{!!!}Board.Who.3.sec'>2(c)</a>

DragAlong.Engage.Xnum={DragAlong.Xnum}.<a class='xref' href='{!!!}DragAlong.Engage.Sec'>2</a>

DragAlong.Cond.5.Xnum={DragAlong.Xnum}.<a class='xref' href='{!!!}DragAlong.Cond.5.sec'>3(e)</a>

DragAlong.Cond.7.Xnum={DragAlong.Xnum}.<a class='xref' href='{!!!}DragAlong.Cond.7.sec'>3(g)</a>

DragAlong.Engage.3.Xnum={DragAlong.Xnum}.<a class='xref' href='{!!!}DragAlong.Engage.3.sec'>2(c)</a>
