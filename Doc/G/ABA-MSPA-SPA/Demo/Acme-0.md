Note=This is a demo file for the Stock Purchase Agreement template. It contains sample data and is not intended for actual use. Indeed, the values are inconsistent and probably non-sensical. Do not rely on this file for any purpose other than as a demonstration of the template's capabilities.
...
Sellers Note=The Sellers are listed in a Schedule. 
 
Seller.Atty.=[G/U/Who/quade_and_quinn.md]

Seller.Representative.=[G/U/Who/safe_hands_inc.md]

Seller.Representative.Handle=<a href="#DefT.Sellers_Representative" type="xref">Sellers' Representative</a>

Seller.Representative.Notice.Name,Title=Sarah Safe, President

Buyer.=[G/U/Who/quake_incorporated.md]

Buyer.Atty.=[G/U/Who/solomon_shirley.md]

Seller.Handle=<a href="#DefT.Seller(s)">Sellers</a>

Buyer.Handle=<a href="#DefT.Buyer">Buyer</a>

Doc.GUID=ABA-001.01

Seller.PartyList.Name.Full=The individuals who have executed the signature page to this {_Agreement}

Seller.US.Contract.Among.Sec=The individuals who have executed the signature page to this {_Agreement} (collectively, “{DefT.Sellers}” and individually, a “{DefT.Seller}”.

Why.sec=As a demonstration of the ABA Model Stock Purchase Agreement.

Seller.US.Contract.By.Sec=<b>{_Sellers}</b><br>The individuals who have executed the signature page to this {_Agreement}.

Annex.sec=Annexes not included.

Business_Day.Jurisdiction=New York

Price.Total.Sum.$=$100,000,000

Price.Close.Sum.$=$95,000,000

Price.Escrow.Sum.$=$5,000,000

Closing.Time.cl=12:00 PM

Closing.Cond.SatisfactionDeadline.YMD=2015-03-15

Closing.EffectiveDate.YMD=2015-03-20

Employee.Agt.Persons.cl=President, CEO, CFO, COO, VP of Sales, VP of Marketing, VP of Operations, VP of Finance, and VP of Human Resources

InterimBalanceSheet.ShareholdersEquity.Sum.$=$50,000,000

Price.Adjust.Mediator.cl=$5,000,000

Noncompete.Years=three years

Noncompete.OtherShare.Max.%=$2,000,000

Law.State.the=the State of New York

Tribunal.State.cl=the Supreme Courts of the State of New York for the Borough of Manhattan

Tribunal.USDC.cl=the district courts of the United States for the Southern District of New York
...
Rep.Seller.Records.Books.Location=the {_Acquired_Company}'s main offices
...
Cond.Buyer.Estoppel.Certificates.Behalf.of=the {_Acquired_Company}
