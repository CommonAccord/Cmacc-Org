...
Why.=[G/Agt-NDA/Sec/Why/0.md]

Relate.Conf.=[G/Agt-NDA/Sec/Relate/Conf/0.md]

Def.=[G/Agt-NDA/Sec/Def/0.md]

Relate.=[G/Agt-NDA/Sec/Relate/0.md]

Misc.=[G/Agt-NDA/Sec/Misc/0.md]
...
//=Defaulting to no Annex.  If you need an Annex, write: "Annex.Div=<hr>{Annex}" and you'll get some framing for annexes.
