Note=Singapore overlay.  Builds on Canadian-Tweaks (from which it inherits Shares-not-Stock) and overrides what differs: s-not-z, "Ordinary Shares" / "Preference Shares" instead of Common/Preferred, SFA rep, Singapore law.

Legend.Home.sec={Legend.Singapore.sec}<br>{Legend.US.sec}<br>
...
Note=Revert to the US list of company reps (no Canadian private-issuer rep).
...
Rep.Investor.Accredited.1.sec=The {_Investor} is an accredited investor as such term is defined in Section 4(a) of the Securities and Futures Act (Chapter 289) of Singapore (the "{DefT.SFA}").
...
Note=2020 → 2026 fix: "laws of Singapore" (was "laws of the Singapore").
