...
CessionConjointe.=[G/GalionProject-BSPCE/MiniPacte/Sec/CessionConjointe/0.md]

1.Sec={CessionConjointe.Sec}

SortieForcée.=[G/GalionProject-BSPCE/MiniPacte/Sec/SortieForcée/0.md]

2.Sec={SortieForcée.Sec}

Préemption.=[G/GalionProject-BSPCE/MiniPacte/Sec/Préemption/0.md]

3.Sec={Préemption.Sec}

Bourse.=[G/GalionProject-BSPCE/MiniPacte/Sec/Bourse/0.md]

4.Sec={Bourse.Sec}

Fusion.=[G/GalionProject-BSPCE/MiniPacte/Sec/Fusion/0.md]

5.Sec={Fusion.Sec}

Conf.=[G/GalionProject-BSPCE/MiniPacte/Sec/Conf/0.md]
