...
0.sec=Each chemical substance constituting or contained in goods sold or otherwise transferred to {_P1} is listed on:
...
Similar=any equivalent lists in any other jurisdiction to or through which {_P1} informs {_P2} the goods will likely be shipped
