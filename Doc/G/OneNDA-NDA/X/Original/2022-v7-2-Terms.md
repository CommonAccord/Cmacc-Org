...
ConfInfo.Communicate.Intro.sec={Def.Confidential_Information} means information that is disclosed:

ConfInfo.Communicate.From.sec=by a party to this {_Agreement} (the {Def.Discloser}) or on the {_Discloser}’s behalf by its authorised representatives or its {_Affiliates},

ConfInfo.Communicate.To.sec=to the other party to this {_Agreement} (the {Def.Receiver}), and
...
Def.Affiliate.sec={Def.Affiliate} means any entity that directly or indirectly controls, is controlled by, is under common control with or is otherwise in the same group of entities as a party to this {_Agreement}.
