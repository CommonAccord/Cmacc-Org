...
Customer_Data={_P1} <a href="#Def.Customer_Data.sec" class="definedterm">Data</a>

Customer_Equipment={_P1} <a href="#Def.Customer_Equipment.sec" class="definedterm">Equipment</a>
...
P1_Affiliate={_P1} <a href="#Def.P1_Affiliate.sec" class="definedterm">Affiliate</a>

P1_Invention={_P1} <a href='#Def.P1_Invention.sec' class='definedterm'>Invention</a>

P1_Inventions={_P1} <a href='#Def.P1_Inventions.sec' class='definedterm'>Inventions</a>

P1_Policy={_P1} <a href="#Def.P2_Policy.sec" class="definedterm">Affiliate</a>

P1_Software={_P1} <a href="#Def.P2_Software.sec" class="definedterm">Software</a>

P2_Affiliate={_P2} <a href="#Def.P2_Affiliate.sec" class="definedterm">Affiliate</a>

P2_Policy={_P2} <a href="#Def.P2_Policy.sec" class="definedterm">Affiliate</a>

P2_Software={_P2} <a href="#Def.P2_Software.sec" class="definedterm">Software</a>
