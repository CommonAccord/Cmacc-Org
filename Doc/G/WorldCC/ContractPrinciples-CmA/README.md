...
See the: <ul><li><a href="http://source.commonaccord.org/index.php?action=doc&file=OTF/WorldCC/ContractPrinciples-CmA/Principle/0.md">full text of the Principles (with Clauses)</a> and <li><a href="http://source.commonaccord.org/index.php?action=doc&file=OTF/WorldCC/ContractPrinciples-CmA/Principle/0.md">just the Clauses</a>.</ul>
