...
Intro.Disclosed.Cl="{Def.Confidential_Information.Target}" means any and all {InfoType.cl} disclosed by {_Disclosing_Party} to {_Receiving_Party} under {_this_Agreement}
