...
0.sec=If you decide to join {_Program}, we will gather data about you. We will gather some of the data from you directly. We will gather some of the data from elsewhere.
...
1.3.1.3.sec=You can say no and still take part in {_Program}.

1.3.1.=[G/Z/para/s3]

1.3.2.1.sec=If you say yes to being measured, it will take about 15 minutes.

1.3.2.2.sec={_Program} trained research staff will do the measurements.
...
1.4.1.3.sec=You can say no and still take part in {_Program}.

1.4.1.=[G/Z/para/s3]

1.4.2.sec={Sample.sec}
...
1.4.6.2.sec=Because {_Program} will last for ten or more years, some of the methods may not even be invented yet.

1.4.6.=[G/Z/para/s2]

1.4.7.1.sec=We will store your blood, urine, and saliva samples in the {_Program} biobank.
...
1.4.8.sec=What researchers learn from studying your samples will be added to the {_Program} databases.

1.4.=[G/Z/paras/s8]

1.5.Ti=Fitness trackers

1.5.1.sec=If you have a fitness tracker (like one to count the steps you take in a day), you might be able to share data from it with {_Program}.

1.5.2.sec=If you don’t have a fitness tracker, we may ask you to use one that we give you.

1.5.3.sec=You can say no and still take part in {_Program}.
...
2.1.1.3.sec=You can say no and still take part in {_Program}, but it might limit what other data we ask to collect from you.
...
2.2.2.0.sec=There are two ways we will add data from other sources to your {_Program} record:
...
2.2.2.2.2.4.sec=You can say no and still take part in {_Program}.
...
2.2.2.2.3.4.sec=Because of this, we will ask the {_Program} ethics committee to review and approve each data source before we add it.
