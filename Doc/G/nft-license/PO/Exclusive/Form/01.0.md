...
_Creator=<a href='#Def.Creator.target' class='definedterm'>Creator</a>

_Collector=<a href='#Def.Collector.target' class='definedterm'>Collector</a>

_Sublicensee=<a href='#Def.Sublicensees.target' class='definedterm'>Sublicensee</a>

_Sublicensees=<a href='#Def.Sublicensees.target' class='definedterm'>Sublicensees</a>

_Collectible_Image=<a href='#Def.Collectible_Image.target' class='definedterm'>Collectible Image</a>

_Terms=<a href='#Def.Terms.target' class='definedterm'>Terms</a>

_NFT=<a href='#Def.NFT.target' class='definedterm'>NFT</a>

_Collectible=<a href='#Def.Collectible.target' class='definedterm'>Collectible</a>

Def.Creator.target={_Creator}

Def.Collectible.target={_Collectible}

Def.Collectible_Image.target={_Collectible_Image}

Def.Collector.target={_Collector}

Def.Sublicensees.target={_Sublicensees}

Def.Personal_Use_Right.target={_Personal_Use_Right}

Def.Resale.target={_Resale}

Def.Resale_Right.target={_Resale_Right}

_Collectors=<a href='#Def.Collectors.target' class='definedterm'>Collectors</a>

_Personal_Use_Right=<a href='#Def.Personal_Use_Right.target' class='definedterm'>Personal Use Right</a>

_Personal_Use_Rights=<a href='#Def.Personal_Use_Right.target' class='definedterm'>Personal Use Rights</a>

_Resale=<a href='#Def.Resale.target' class='definedterm'>Resale</a>

_Resale_Right=<a href='#Def.Resale_Right.target' class='definedterm'>Resale Right</a>
