Why.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Why/0.md]

Def.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Def/0.md]

Background.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Background/0.md]

Purpose.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Purpose/0.md]

Scope.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Scope/0.md]

Document.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Document/0.md]

Term.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Term/0.md]

Termination.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Termination/0.md]

TermAfter.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/TermAfter/0.md]

Exclusive.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Exclusive/0.md]

Delivery.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Delivery/0.md]

ProductAndService.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/ProductAndService/0.md]

ManufacturerResponsibility.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/ManufacturerResponsibility/0.md]

ManufacturerWarranty.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/ManufacturerWarranty/0.md]

Personnel.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Personnel/0.md]

SoftwareLicense.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/SoftwareLicense/0.md]

FinancialCondition.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/FinancialCondition/0.md]

IP.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/IP/0.md]

Support.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Support/0.md]

Indemnify.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Indemnify/0.md]

AdditionalRep.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/AdditionalRep/0.md]

Liability.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Liability/0.md]

Insurance.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Insurance/0.md]

Confidentiality.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Confidentiality/0.md]

Governance.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Governance/0.md]

Audit.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Audit/0.md]

Marketing.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Marketing/0.md]

ForceMajeure.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/ForceMajeure/0.md]

Subcontract.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Subcontract/0.md]

Transfer.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Transfer/0.md]

Comply.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/Comply/0.md]

ComplyLaw.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/ComplyLaw/0.md]

General.=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/General/0.md]

_=[G/Agt-Supply-EquipmentSoftwareSupport/Sec/_/0.md]

sec=<ol><li>{Def.Sec}<li>{Background.Sec}<li>{Purpose.Sec}<li>{Scope.Sec}<li>{Document.Sec}<li>{Term.Sec}<li>{Termination.Sec}<li>{TermAfter.Sec}<li>{Exclusive.Sec}<li>{Delivery.Sec}<li>{ProductAndService.Sec}<li>{ManufacturerResponsibility.Sec}<li>{ManufacturerWarranty.Sec}<li>{Personnel.Sec}<li>{SoftwareLicense.Sec}<li>{FinancialCondition.Sec}<li>{IP.Sec}<li>{Support.Sec}<li>{Indemnify.Sec}<li>{AdditionalRep.Sec}<li>{Liability.Sec}<li>{Insurance.Sec}<li>{Confidentiality.Sec}<li>{Governance.Sec}<li>{Audit.Sec}<li>{Marketing.Sec}<li>{ForceMajeure.Sec}<li>{Subcontract.Sec}<li>{Transfer.Sec}<li>{Comply.Sec}<li>{ComplyLaw.Sec}<li>{General.Sec}</ol>
