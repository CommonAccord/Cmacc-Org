...
Doc={Head.Sec}<br>{sec}{Foot.Sec} 

Head.Sec={Head.Message}<center><h4>{Head.sec}</h4></center>

Head.Message=<font color="grey">{MessageToUser} GUID: {Doc.GUID}</font>
...
1.Sec=<span class="sec-ti">{1.Ti}</span><br>{1.image}{1.sec}

1.sec={1.0.sec}{1.xlist}{1.00.sec}

1.xlist=<ul type="none"><li>{1.Secs}</ul>
...
12.Sec=<span class="sec-ti">{12.Ti}</span><br>{12.sec}
...
28.xlist=<ul type="none"><li>{28.Secs}</ul>
...
39.sec={39.0.sec}{39.xlist}{39.00.sec}
...
55.xlist=<ul type="none"><li>{55.Secs}</ul>
