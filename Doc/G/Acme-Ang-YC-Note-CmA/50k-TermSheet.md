...
r00t=<b>Investment Note</b><br><table><tr><td>Company:</td><td>{Company.Name.Full}</td></tr><tr><td>Purchase Amount:</td><td>{PurchaseAmount.$}</td></tr><tr><td>Date Funded:  </td><td>{EffectiveDate.YMD}</td></tr><tr><td>Post-Money Valuation Cap:  </td><td>{Post-MoneyValueCap.$}</td></tr><tr><td>Discount Rate:  </td><td>{DiscountRate.%}</td></tr><tr><td>Applicable Law:  </td><td>{Law.State}</td></tr><tr><td>Signatures:</td></tr><tr><td valign="top">{Company.Name.Full}:<ul type=none><li>{Company.Signer.Name.Full}<li>{Company.Sign.YMD}</ul></td><td valign="top">{Investor.Name.Full}:<ul type=none><li>{Company.Sign.YMD}</ul></td></tr></table>
