...
1.sec={_Inventions} assigned to {_Company} or to a third party as directed by {_Company} pursuant to Section {Invention.AssignToUSGovt.Xnum} are referred to in this {_Agreement} as “{DefT.P1_Invention}s.”  

2.sec=Subject to Section {Invention.CaliforniaSpecificInventionsLaw.Xnum} and except for {_Excluded_Inventions} set forth in Exhibit A and {_Other_Inventions}, I hereby assign to {_Company} all my right, title, and interest in and to any and all {_Inventions} (and all {_Intellectual_Property_Rights} with respect thereto) made, conceived, reduced to practice, or learned by me, either alone or with others, during the period of my employment by {_Company}.
