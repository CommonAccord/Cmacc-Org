...
Def.Sec=<b>DEFINITIONS</b><br><ul type=none><li>{Def.Challenging_Party}</li><li>{Def.Confidential}</li><li>{Def.Counsel}</li><li>{Def.Designated_House_Counsel}</li><li>{Def.Designating_Party}</li><li>{Def.Disclosure_or_Discovery_Material}</li><li>{Def.Expert}</li><li>{Def.Highly_Confidential_-_Attorneys_Eyes_Only}</li><li>{Def.Highly_Confidential_-_Source_Code}</li><li>{Def.House_Counsel}</li><li>{Def.Non-Party}</li><li>{Def.Outside_Counsel_of_Record}</li><li>{Def.Party}</li><li>{Def.Producing_Party}</li><li>{Def.Professional_Vendors}</li><li>{Def.Protected_Material}</li><li>{Def.Receiving_Party}</li></ul>
...
ExhA.=[G/USDC-CAND-PatentProtectiveOrder/Exh_A_Agreement_to_be_Bound/0.md]
