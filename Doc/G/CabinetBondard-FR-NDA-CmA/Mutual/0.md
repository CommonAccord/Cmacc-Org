...
Def.Éléments_Confidentiels.sec={_Éléments_Confidentiels}
...
_partie=<a href="#Def.Partie.sec" class="definedterm">Partie</a>

_parties=<a href="#Def.Partie.sec" class="definedterm">Parties</a>

_Partie=<a href="#Def.Partie.sec" class="definedterm">Partie</a>

_Parties=<a href="#Def.Partie.sec" class="definedterm">Parties</a>

_Éléments_Confidentiels=<a href="#Def.Éléments_Confidentiels.sec" class="definedterm">Éléments Confidentiels</a>

_Créations=<a href="#Def.Créations.sec" class="definedterm">Créations</a>