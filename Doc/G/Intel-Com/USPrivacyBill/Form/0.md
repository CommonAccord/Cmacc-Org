...
Introduction.=[G/Intel-Com/USPrivacyBill/Sec/Introduction/0.md]

Title.Ti=SHORT TITLE; TABLE OF CONTENTS; GENERAL APPLICATION

Title.sec=<ol><li>{ShortTitle.Sec}<li>{ToC.Sec}</ol>

ShortTitle.=[G/Intel-Com/USPrivacyBill/Sec/ShortTitle/0.md]

ToC.=[G/Intel-Com/USPrivacyBill/Sec/TableOfContents/0.md]

Title.=[G/Z/ol/Base]

Finding.=[G/Intel-Com/USPrivacyBill/Sec/Finding/0.md]

Def.=[G/Intel-Com/USPrivacyBill/Sec/Def/0.md]

Principle.=[G/Intel-Com/USPrivacyBill/Sec/Principle/0.md]

OversightOfThirdParties.=[G/Intel-Com/USPrivacyBill/Sec/OversightOfThirdParties/0.md]

FTC-Authority.=[G/Intel-Com/USPrivacyBill/Sec/FTC-Authority/0.md]

SanctionSafeHarbor.=[G/Intel-Com/USPrivacyBill/Sec/SanctionSafeHarbor/0.md]

FTC-Guidance.=[G/Intel-Com/USPrivacyBill/Sec/FTC-Guidance/0.md]

FTC-Resources.=[G/Intel-Com/USPrivacyBill/Sec/FTC-Resources/0.md]

LegalPreemption.=[G/Intel-Com/USPrivacyBill/Sec/LegalPreemption/0.md]

SavingsClause.=[G/Intel-Com/USPrivacyBill/Sec/SavingsClause/0.md]

EffectiveDate.=[G/Intel-Com/USPrivacyBill/Sec/EffectiveDate/0.md]
