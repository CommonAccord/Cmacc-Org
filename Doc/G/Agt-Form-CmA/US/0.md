...
Among.Def.sec/NoDef=Each a "{_Party}" (as defined below) and collectively the "{_Parties}."
...
This.sec/2-NoDef=This {Doc.Ti} (this "{_Agreement}" as defined below) is made as of {EffectiveDate.YMD} (the "{_Effective_Date}" as defined below), by and between the {_parties}.
...
This.sec/3-NoDef=This {Doc.Ti} (this "{_Agreement}" as defined below) is made as of {EffectiveDate.YMD} (the "{_Effective_Date}" as defined below), by and among the {_parties}.
