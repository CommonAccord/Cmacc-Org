...
This.sec/2-NotTarget=This {Doc.Ti} (this "{_Agreement}") is made as of {EffectiveDate.YMD} (the "{_Effective_Date}"), by and between the {_parties}.
...
This.sec/3-NotTarget=This {Doc.Ti} (this "{_Agreement}") is made as of {EffectiveDate.YMD} (the "{_Effective_Date}"), by and among the {_parties}.
