...
Among.Def.sec=Each a "{Def.Party.Target}" and collectively the "{_Parties}."
...
Friend.Def.sec=Each a "{_Named_Third_Party}" and collectively the "{Def.Named_Third_Parties.Target}."
