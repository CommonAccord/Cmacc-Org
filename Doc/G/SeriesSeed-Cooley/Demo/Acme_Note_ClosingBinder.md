...
=[G/SeriesSeed-Cooley/Demo/Acme_DealPoints.md]

//=Then the set of forms:

TermSheet.=[G/SeriesSeed-Cooley/notes/Term_Sheet/0.md]

TermsOfPreferred.=[G/SeriesSeed-Cooley/notes/Convertible_Promissory_Note/TermsOfSeriesSeed/0.md]

BoardConsent.=[G/SeriesSeed-Cooley/notes/Board_Consent/0.md]

Seed.1.Questionnaire.=[G/SeriesSeed-Cooley/notes/Investor_Questionnaire/0.md]

PromissoryNote.=[G/SeriesSeed-Cooley/notes/Convertible_Promissory_Note/0.md]

_=[G/SeriesSeed-Cooley/Sec/DefinedTerm/0.md]

Def.=[G/SeriesSeed-Cooley/Sec/DefinedTerm-Inline/0.md]
