...
1.2.sec=por «exportador de datos» se entenderá el responsable del tratamiento que transfiera los datos personales;
c)
...
4.Ti=Obligaciones del exportador de datos
...
5.Ti=Obligaciones del importador de datos  (2)
