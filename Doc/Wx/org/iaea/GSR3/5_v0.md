...
Req.47.Sec=<b>{Req.47.Ti}</b><br>{Req.47.Text}<ol start=2><li>{2.sec}<li>{3.sec}<li>{4.sec}<li>{5.sec}</ol>
...
H.3.Sec=<b>{H.3.Ti}</b><br>{H.1.Ti}<br>{6.sec}<br>{Req.48.Sec}{Req.49.Sec}{Req.50.Sec}{Req.51.Sec}
...
Req.48.Sec=<b>{Req.48.Ti}</b><br>{Req.48.Text}<ol start=7><li>{7.sec}<li>{8.sec}<li>{9.sec}</ol>
...
Req.49.Sec=<b>{Req.49.Ti}</b><br>{Req.49.Text}<ol start=10><li>{10.sec}<li>{11.sec}<li>{12.sec}<li>{13.sec}<li>{14.sec}<li>{15.sec}<li>{16.sec}<li>{17.sec}<li>{18.sec}</ol>
...
Req.50.Sec=<b>{Req.50.Ti}</b><br>{Req.50.Text}<ol start=19><li>{19.sec}<li>{20.sec}<li>{21.sec}</ol>
...
20.2.sec=Reducing activity concentrations of 222Rn and consequent exposures to levels at which protection is optimized;

20.3.sec=Giving priority to actions to reduce activity concentrations of 222Rn in those situations for which such action is likely to be most effective{Footnote_56};

20.4.sec=Including in building codes appropriate preventive measures and corrective actions to prevent the ingress of 222Rn and to facilitate further actions wherever necessary.

20.=[Z/ol-a/s4]

21.0.sec=The government shall assign responsibility for:

21.1.sec=Establishing and implementing the action plan for controlling public exposure due to 222Rn indoors;
...
Req.51.Sec=<b>{Req.51.Ti}</b><br>{Req.51.Text}<ol start=22><li>{22.sec}<li>{23.sec}</ol>
...
H.4.2.Ti=Remediation of areas with residual radioactive material
...
H.4.3.Ti=Exposure due to radon in workplaces
...
H.4.4.Ti=Exposure of aircrew and space crew due to cosmic radiation
