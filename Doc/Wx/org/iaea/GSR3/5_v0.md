...
Req.52.Sec=<b>{Req.52.Ti}</b><br>{Req.52.Text}<ol start=25><li>{25.sec}</ol>{Req.52.1.Ti}<ol start=26><li>{26.sec}</ol>{Req.52.2.Ti}<ol start=27><li>{27.sec}<li>{28.sec}<li>{29.sec}</ol>{Req.52.3.Ti}<ol start=30><li>{30.sec}<li>{31.sec}<li>{32.sec}<li>{33.sec}</ol>
