...
3.3.sec=Shall assign responsibilities for the establishment and implementation of protection strategies to the regulatory body and to other relevant authorities51 and, as appropriate, to registrants, licensees and other parties involved in the implementation of remedial actions and protective actions;
