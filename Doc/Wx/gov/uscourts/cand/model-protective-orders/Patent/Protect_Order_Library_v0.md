...
Challenge.Sec=<b>CHALLENGING CONFIDENTIALITY DESIGNATIONS</b><br><ol><li>{Challenge.Timing.tx}</li><li>{Challenge.Confer.tx}</li><li>{Challenge.Judge.tx}</li></ol>

Access.Sec=<b>ACCESS TO AND USE OF {PROTECTED MATERIAL}</b><br><ol><li>{Access.Principle.tx}</li><li>{Access.Confidential.Who.tx}</li><li>{Access.HighlyConfidential.Who.tx}</li><li>{Access.HighlyConfidential.Procedure.tx}</li></ol>

SourceCode.Sec=<b>SOURCE CODE</b><br> <ol><li>{SourceCode.Designate.tx}</li><li>{SourceCode.Protection.tx}</li><li>{SourceCode.Access.tx}</li><li>{SourceCode.PaperCopy.tx}</li><li>{SourceCode.Care.tx}</li></ol>

OtherLit.Sec=<b>{PROTECTED MATERIAL} SUBPOENAED OR ORDERED PRODUCED IN OTHER LITIGATION</b><br>{OtherLit.Intro}:<ol><li>{OtherLit.NotifyDesignatingParty.tx};</li><li>{OtherLit.NotifyOtherLitigant.tx}; and</li><li>{OtherLit.Cooperate.tx}.</li></ol>{OtherLit.Wait.tx}


Non-PartyInfo.Sec=<b>A {NON-PARTY}'S {PROTECTED MATERIAL} SOUGHT TO BE PRODUCED IN THIS LITIGATION</b><br><ol><li>{Non-PartyInfo.IsSubject.tx}</li><li>{Non-PartyInfo.Procedure.tx}</li><li>{Non-PartyInfo.TimeForObjection.tx}</li></ol>

Misc.Sec=<b>MISCELLANEOUS</b><br><ol><li>{Misc.FurtherRelief.tx}</li><li>{Misc.OtherObjection.tx}</li><li>{Misc.ExportControl.tx}</li><li>{Misc.NoOpenFiling.tx}</li></ol>

Purpose.Sec=<b>PURPOSES AND LIMITATIONS</b><br>Disclosure and discovery activity in this action are likely to involve production of confidential, proprietary, or private information for which special protection from public disclosure and from use for any purpose other than prosecuting this litigation may be warranted. Accordingly, the parties hereby stipulate to and petition the court to enter the following Stipulated Protective Order. The parties acknowledge that this Order does not confer blanket protections on all disclosures or responses to discovery and that the protection it affords from public disclosure and use extends only to the limited information or items that are entitled to confidential treatment under the applicable legal principles. The parties further acknowledge, as set forth in Section {14.4} below, that this Stipulated Protective Order does not entitle them to file confidential information under seal; {Civil Local Rule 79-5} sets forth the procedures that must be followed and the standards that will be applied when a party seeks permission from the court to file material under seal.

Def.Sec=<b>DEFINITIONS</b><br><ul type=none><li>{Def.Challenging Party}</li><li>{Def.Confidential}</li><li>{Def.Counsel}</li><li>{Def.Designated House Counsel}</li><li>{Def.Designating Party}</li><li>{Def.Disclosure or Discovery Material}</li><li>{Def.Expert}</li><li>{Def.Highly Confidential - Attorneys' Eyes Only}</li><li>{Def.Highly Confidential - Source Code}</li><li>{Def.House Counsel}</li><li>{Def.Non-Party}</li><li>{Def.Outside Counsel of Record}</li><li>{Def.Party}</li><li>{Def.Producing Party}</li><li>{Def.Professional Vendors}</li><li>{Def.Protected Material}</li><li>{Def.Receiving Party}</li></ul>

Def.Challenging Party="Challenging Party": a Party or Non-Party that challenges the designation of information or items under this Order.
