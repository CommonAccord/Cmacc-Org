...
P1.Among.Alt1.Block=<ul type="none">{P1.Name.Full}</li><li>{P1.Among.Alt1.ID.sec}</li><li>{P1.Among.Alt1.Address.sec}</li><li>{P1.Among.Alt1.Agent.sec}<br><div align="right">{P1.Among.Alt1.Handle.sec},</div></ul>

P1.Among.Alt2.Block=<ul type="none">{P1.Name.Full}</li><li>{P1.Among.Alt2.ID.sec}</li><li>{P1.Among.Alt2.Address.sec}</li><li>{P1.Among.Alt2.Agent.sec}<br><div align="right">{P1.Among.Alt2.Handle.sec},</div></ul>

P1.Among.Block=<b>Choose: P1.Among.Block=P1.Among.AltX.Block</b><ol><li>{P1.Among.Alt1.Block}</li><li>{P1.Among.Alt2.Block}</li></ol>

P2.Among.Alt1.Block=<ul type="none">{P2.Name.Full}</li><li>{P2.Among.Alt1.ID.sec}</li><li>{P2.Among.Alt1.Address.sec}</li><li>{P2.Among.Alt1.Agent.sec}<br><div align="right">{P2.Among.Alt1.Handle.sec},</div></ul>

P2.Among.Alt2.Block=<ul type="none">{P2.Name.Full}</li><li>{P2.Among.Alt2.ID.sec}</li><li>{P2.Among.Alt2.Address.sec}</li><li>{P2.Among.Alt2.Agent.sec}<br><div align="right">{P2.Among.Alt2.Handle.sec},</div></ul>
