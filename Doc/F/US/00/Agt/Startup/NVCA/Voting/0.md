...
00.2.sec={KeyHolder.US.Frame.Sign.Block}

00.3.sec={Investor.US.Frame.Sign.Block}
...
Annex.Sec=<hr><hr>{Schedule.A.Sec}<hr><hr>{Schedule.B.Sec}<hr><hr><h3>Exhibit A</h3> <hr>{Exh.1.Doc}<hr><hr><h3>Exhibit B </h3><hr>{Exh.2.Doc}<hr><hr><h3>Additional Provisions</h3> <hr>{Add.1.Doc}


Schedule.A.Sec=SCHEDULE A<br>INVESTORS<br>Name and Address	Number of Shares Held


Schedule.B.Sec=SCHEDULE B<br>KEY HOLDERS<br>Name and Address	Number of Shares Held
	

Exh.1.Doc.Ti=ADOPTION AGREEMENT
