Doc.Title=CONTRAT DE CESSION DE DROITS DE PROPRIÉTÉ INTELLECTUELLE ( ASSOCIÉ ) 

Note=Look to see if we need these:

0.1.sec=ENTRE LES SOUSSIGNÉ(E)S :<br><br>

P1.1.sec=Monsieur ou Madame {Nom_Prénom}

P1.2.sec=Né(e) le {Date_Naissance} à {Lieu_Naissance}<br>De nationalité {Nationalité}<br>Exerçant la profession de {Profession}

P1.3.sec=Demeurant {Adresse_Domicile}

P1.4.sec=Ci-après dénommé(e) le "Cédant",
