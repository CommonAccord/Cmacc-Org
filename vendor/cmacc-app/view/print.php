...
$document = `vendor/cmacc-app/view/py_render/parser-print.py G/Agt-Form-CmA/US/0.md Doc Model.Root` ;

# $document = $document . `perl $lib_path/parser-print.pl $path/$dir`;
